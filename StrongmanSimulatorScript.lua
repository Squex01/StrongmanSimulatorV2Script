...
-- LOAD GUI & LIBRARY --
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Squex01/StrongmanSimulatorV2Script/main/StrongmanSimulator.lua", true))()
local w = library:CreateWindow('Strongman Simulator')

-- GUI SECTION
w:Section('Created by Jigsaw')
